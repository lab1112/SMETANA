...
int main(void)
{
  ...
  int a=0;
  int b=0;
  float x=0;//требуемый угол поворота по горизонтали
  float y=0;//требуемый угол поворота по вертикали
  float x1=0;
  float y1=0;
  float  da=0;//рассогласование угла по горизонтали
  float  db=0;//рассогласование угла по вертикали
  float  dda=0;//производная рассогласования по горизонтали
  float ddb=0;//производная рассогласования по вертикали
  float ia=0;//интеграл рассогласования по горизонтали
  float ib=0;//интеграл рассогласования по вертикали
  float  pa=0;//управляющий сигнал 1
  float  pb=0;//управляющий сигнал 2
  float  da1=0;
  float  db1=0;
  float g=0;//текущий угол поворота по горизонтали в градусах
